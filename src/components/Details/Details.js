...
const Details = ({times,breakTime}) => {
    ...
    return (
        <div className='mt-6'>
            ...
            <div>
                <h2 className='overflow-hidden border border-sky-500 rounded-lg bg-white text-3xl p-5 sm:w-5/12 lg:w-96'>Excerise Time:{totalTime}S</h2>
                <h2 className=' overflow-hidden border border-sky-500 rounded-lg bg-white text-3xl p-5 mt-5 mb-5 sm:w-5/12 lg:w-96'>Break Time:{breakTime}</h2>
            </div>
