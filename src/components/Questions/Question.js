...
const Question = () => {
    return (
        <div className='mt-6 mb-6'>
            ...
            <div className="card lg:w-9/12 sm:w-7/12 bg-neutral-400 shadow-2xl sm:mb-10 ">
            ...
            <div className="card lg:w-9/12 sm:w-7/12 bg-neutral-400 shadow-2xl sm:mt-6">
               <div className="card-body">
            ...
            <div className="card lg:w-9/12 bg-neutral-400 shadow-2xl sm:mt-10">
               <div className="card-body">
